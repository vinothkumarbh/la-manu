...
$pat = new Patient();
$app = new Appointment();
$res = $pat->patient_profile($_GET['pid'])->fetchAll(PDO::FETCH_ASSOC);
$app_res = $app->get_app_by_patId($_GET['pid'])->fetchAll(PDO::FETCH_ASSOC);
?>
...
<body>
    ...
    <h1 class='text-center text-light'>Patient Info</h1>
    ...
    <?php 
        if($res) {
            ...
            ?>
                <a href="edit_patient.php?editp=<?php echo $data['id']  ?>" class='text-warning bg-dark ps-3'>Edit</a>
                <?php
            }
        }
        ?>
